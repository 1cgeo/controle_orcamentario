  ...
  GRANT USAGE ON SCHEMA orcamentario TO $1:name;
  GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA orcamentario TO $1:name;
  GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA orcamentario TO $1:name;
